  ...
  if (mode === 'grid') {
    ...
    if (folderView) {
      ...
      return (
        <div className="px-2 lg:px-4 py-4 space-y-4">
          <div className="flex items-center justify-between animate-fadeInUp anim-delay-0">
          ...
          {/* Search + Filters */}
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-3 animate-fadeInUp anim-delay-1">
          ...
          {/* Files grid */}
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4 animate-fadeInUp anim-delay-2">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {files.map((f) => (
                <div key={f} className="rounded-xl border border-gray-200 bg-white hover-lift-md hover-glow transition overflow-hidden animate-fadeInUp" style={{animationDelay: '.06s'}}>
    ...
    return (
      <div className="relative px-2 lg:px-4 py-4 space-y-4">
        {/* Quick Access */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm p-4 animate-fadeInUp anim-delay-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {[
              ...
              <div
                key={card.name}
                className="rounded-xl border border-gray-200 dark:border-gray-800 p-3 hover-lift-md hover-glow transition bg-white dark:bg-gray-800 cursor-pointer animate-fadeInUp"
        ...
        {/* Files Table */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden animate-fadeInUp anim-delay-1">
          ...
          <div className="overflow-x-auto">
            ...
            <div className="min-w-[720px] divide-y divide-gray-200 dark:divide-gray-800">
              {[
                ...
                <div
                  key={r.name}
                  className="grid grid-cols-12 gap-3 px-4 py-2.5 hover:bg-blue-50 dark:hover:bg-gray-800 cursor-pointer animate-fadeInUp"
